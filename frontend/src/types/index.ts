...
export interface SessionUser { id: string; firstName: string; lastName: string; name: string; email: string;address?: string; employeeId?: string; phone?: string; role: Role; locked?: boolean; mustChangePassword?: boolean; employeeStatus?: "ACTIVE" | "INACTIVE"; addresses?: Address[]; }
