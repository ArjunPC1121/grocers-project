...
import { EmployeeDashboard, EmployeeLayout, EmployeeOrders, UnlockTickets } from "./pages/employee/EmployeeWorkspace";
...
export default function App() { return <><Toaster position="top-right"/><Routes>
  ...
  <Route element={<RoleGuard allow={["EMPLOYEE"]}/> }><Route path="/employee" element={<EmployeeLayout/>}><Route index element={<EmployeeDashboard/>}/><Route path="requests" element={<EmployeeProductRequests/>}/><Route path="orders" element={<EmployeeOrders/>}/><Route path="tickets" element={<UnlockTickets/>}/><Route path="profile" element={<ProfilePage/>}/></Route><Route path="/employee/change-password" element={<EmployeePasswordChange/>}/></Route>
