...
import { EmployeeAccessGuard, EmployeeDashboard, EmployeeOrders, EmployeeProfile, InventoryRequests, TicketHistory } from "./pages/employee/EmployeeWorkspace";
...
export default function App() { return <><Toaster position="top-right"/><Routes>
  ...
  <Route element={<RoleGuard allow={["EMPLOYEE"]}/> }><Route path="/employee" element={<EmployeeAccessGuard/>}><Route index element={<EmployeeDashboard/>}/><Route path="requests" element={<InventoryRequests/>}/><Route path="product-requests" element={<EmployeeProductRequests/>}/><Route path="orders" element={<EmployeeOrders/>}/><Route path="tickets" element={<UnlockTickets/>}/><Route path="ticket-history" element={<TicketHistory/>}/><Route path="profile" element={<EmployeeProfile/>}/></Route><Route path="/employee/change-password" element={<EmployeePasswordChange/>}/></Route>
  <Route element={<RoleGuard allow={["ADMIN"]}/> }><Route path="/admin" element={<AdminShell/>}><Route index element={<LiveAdminDashboard/>}/><Route path="products" element={<ProductManagement/>}/><Route path="users" element={<UserManagement/>}/><Route path="requests" element={<RequestManagementFinal/>}/><Route path="employees" element={<EmployeeManagementPageV2/>}/><Route path="admins" element={<AdminAccounts/>}/><Route path="profile" element={<AdminProfile/>}/><Route path="reports" element={<ReportsDashboard/>}/></Route></Route>
