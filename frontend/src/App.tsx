...
import { EmployeeAccessGuard, EmployeeDashboard, EmployeeOrders, EmployeeProfile, TicketHistory } from "./pages/employee/EmployeeWorkspace";
...
export default function App() { return <><Toaster position="top-right"/><Routes>
  ...
  <Route element={<RoleGuard allow={["EMPLOYEE"]}/> }><Route path="/employee" element={<EmployeeAccessGuard/>}><Route index element={<EmployeeDashboard/>}/><Route path="requests" element={<EmployeeProductRequests/>}/><Route path="product-requests" element={<EmployeeProductRequests/>}/><Route path="orders" element={<EmployeeOrders/>}/><Route path="tickets" element={<UnlockTickets/>}/><Route path="ticket-history" element={<TicketHistory/>}/><Route path="profile" element={<EmployeeProfile/>}/></Route><Route path="/employee/change-password" element={<EmployeePasswordChange/>}/></Route>
