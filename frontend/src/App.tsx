...
import ButtonHoverLabels from "./components/ButtonHoverLabels";
import SupportAssistant from "./components/SupportAssistant";
import { CustomerChatCoordinator, CustomerSupportChat, EmployeeSupportChat } from "./pages/chat/ChatSupport";
// This is the application's route map. RoleGuard keeps customer, employee,
// and admin pages separate even when somebody enters a URL directly.
export default function App() { return <><ButtonHoverLabels/><Toaster position="top-right"/><CustomerChatCoordinator/><Routes>
